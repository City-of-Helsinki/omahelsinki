        ...
        <div className="oma-settings">
            ...
            <Form>
                ...
                <If condition={enableNotifications}>
                    <FormGroup onChange={messagesHandler} className="oma-settings__messages">
                    ...
                    <FormGroup onChange={notificationsHandler} className="oma-settings__notifications">
                        <h4>{intl.formatMessage({id: 'onboarding.notifications.heading'})}</h4>
